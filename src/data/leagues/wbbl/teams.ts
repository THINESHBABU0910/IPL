...
export const WBBL_TEAMS: TeamDef[] = [
  ...
  { id: "MS-W", name: "Melbourne Stars", shortName: "MS", primaryColor: "#00B5E2", secondaryColor: "#1A1A1A", logo: "MS", logoUrl: "/logos/wbbl/MS.svg" },
  { id: "PS-W", name: "Perth Scorchers", shortName: "PS", primaryColor: "#FF6600", secondaryColor: "#1A1A1A", logo: "PS", logoUrl: "/logos/wbbl/PS.svg" },
  { id: "SS-W", name: "Sydney Sixers", shortName: "SS", primaryColor: "#E40046", secondaryColor: "#1A1A1A", logo: "SS", logoUrl: "/logos/wbbl/SS.svg" },
